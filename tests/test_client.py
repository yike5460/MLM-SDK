...
class TestMlm:
    ...
    def test_client_timeout_option(self) -> None:
        client = Mlm(base_url=base_url, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_base_url_setter(self) -> None:
        client = Mlm(base_url="https://example.com/from_init", _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(MLM_BASE_URL="http://localhost:5000/from/env"):
            client = Mlm(_strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            Mlm(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True),
            Mlm(
    ...
    def test_base_url_trailing_slash(self, client: Mlm) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Mlm) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Mlm) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Mlm(base_url=base_url, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Mlm(base_url=base_url, _strict_response_validation=True)
...
class TestAsyncMlm:
    ...
    async def test_client_timeout_option(self) -> None:
        client = AsyncMlm(base_url=base_url, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    @pytest.mark.parametrize(
        "client",
        [
            AsyncMlm(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True),
            AsyncMlm(
                base_url="http://localhost:5000/custom/path/",
                _strict_response_validation=True,
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncMlm(base_url=base_url, _strict_response_validation=True)
